...
colour_input = '/application/pi/eclipse-workspace/blueMaritimeDigitalJournal/src/main/java/org/marineDigitalJournal/neuralnet/data/colour/currentData/data.nc'
insitu_input = 0.5 # insitu data input (for now random)
#Threshold to detect high-biomass blooms that may be potentially harmful. CMEMS validated amounts: 10mg m-3.
max_level = 0.1 # maximum CHL concentration which should trigger an email
#################################################
...
plt.savefig(save_results_to1+ 'CHL_predictions_next_day1.png', dpi = 300)
...
plt.savefig(save_results_to + 'predictions_high_CHL_locations1.png', dpi = 300)
